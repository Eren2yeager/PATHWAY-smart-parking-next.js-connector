...
function getOccupancyColor(occupancyRate: number): {
  bg: string;
  border: string;
  text: string;
} {
        ...
        <div style={{ padding: theme.spacing[6] }}>
          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1">
              ...
              <div
                className="flex items-center dark:text-[#9ca3af]"
                style={{
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <div
                className="flex items-center justify-between dark:text-[#9ca3af]"
                style={{
            ...
            {/* Status Indicators */}
            <div
              className="flex items-center justify-between dark:border-[#2a2e37]"
              style={{
