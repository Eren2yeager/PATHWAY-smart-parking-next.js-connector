  ...
  const renderContractorItem = (
    ...
    return (
      <Link
        ...
        className="dark:bg-[#181a1f] dark:border-[#2a2e37] dark:hover:bg-[#2a2e37]"
      >
  ...
  if (loading) {
    return (
      <div className="bg-white dark:bg-[#111316] rounded-lg shadow dark:shadow-none border border-gray-200 dark:border-[#2a2e37] p-6">
        <h3 className="text-lg font-bold text-gray-900 dark:text-[#e5e7eb] mb-4">Contractor Performance</h3>
        <div className="space-y-3 animate-pulse">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-16 bg-gray-200 dark:bg-[#2a2e37] rounded"></div>
          ))}
        </div>
      </div>
    );
  ...
  return (
    <div className="bg-white dark:bg-[#111316] rounded-lg shadow dark:shadow-none border border-gray-200 dark:border-[#2a2e37] p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-bold text-gray-900 dark:text-[#e5e7eb]">Contractor Performance</h3>
        <button
      ...
      {topPerformers.length === 0 && bottomPerformers.length === 0 && (
        <div className="text-center py-8">
          <p className="text-gray-500 dark:text-[#9ca3af]">No contractor data available</p>
        </div>
      )}
    </div>
  );
