...
import { theme, getStatusColor } from '@/lib/utils/theme';
  ...
  switch (severity) {
    case 'critical':
      return {
        ...
        darkBackgroundColor: 'rgba(220, 38, 38, 0.1)',
    ...
    case 'high':
      return {
        ...
        darkBackgroundColor: 'rgba(245, 158, 11, 0.1)',
        darkBorderColor: '#fcd34d',
    ...
    case 'low':
      return {
        ...
        darkBackgroundColor: 'rgba(6, 182, 212, 0.1)',
        darkBorderColor: '#22d3ee',
        darkTextColor: '#cffafe',
        darkIconColor: '#06b6d4',
      };
    default:
      return {
        ...
        icon: <Info className="w-5 h-5" />,
        darkBackgroundColor: 'rgba(73, 73, 86, 0.1)',
        darkBorderColor: '#a1a1aa',
        darkTextColor: '#d4d4d8',
        darkIconColor: '#a1a1aa',
      };
  }
}
      ...
      {criticalAlerts.map((alert) => {
        ...
        return (
          <div
            ...
            className="dark:bg-[#181a1f] dark:border-l-[#f87171]"
          >
            <div className="flex items-start">
              <div style={{ color: config.iconColor, marginTop: '0.125rem' }} className="dark:text-[#f87171]">
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center space-x-2 ml-4">
                    <button
                      ...
                      className="dark:bg-[#181a1f] dark:text-[#f87171]"
                    >
      ...
      {otherAlerts.map((alert) => {
        ...
        return (
          <div
            ...
            className="dark:bg-[#181a1f] dark:border-l-[#fcd34d]"
          >
            <div className="flex items-start">
              <div style={{ color: config.iconColor, marginTop: '0.125rem' }} className="dark:text-[#fcd34d]">{config.icon}</div>
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center space-x-2 ml-4">
                    <button
                      ...
                      title="Acknowledge alert"
                      aria-label="Acknowledge alert"
                      className="dark:bg-[#181a1f] dark:text-[#fcd34d]"
                    >
