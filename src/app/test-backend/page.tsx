...
export default function TestBackendPage() {
  const [backendUrl, setBackendUrl] = useState(process.env.NEXT_PUBLIC_PATHWAY_BACKEND_URL || process.env.NEXT_PUBLIC_PYTHON_BACKEND_URL || 'http://localhost:8000');
  ...
  const [signalingUrl, setSignalingUrl] = useState(process.env.NEXT_PUBLIC_PATHWAY_BACKEND_WS_URL || process.env.NEXT_PUBLIC_PYTHON_BACKEND_WS_URL || 'ws://localhost:8000');
